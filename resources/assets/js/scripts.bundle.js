...
var KTBlockUI = function (e, t)
{
	...
	if (null != e)
	{
		var i = {
				...
				overlayClass: "",
				overflow: "hidden",
				message: '<span className="spinner-border text-primary"></span>'
			},
			r = function ()
			{
				n.options = KTUtil.deepExtend(
				{}, i, t), n.element = e, n.overlayElement = null, n.blocked = !1, n.positionChanged = !1, n.overflowChanged = !1, KTUtil.data(n.element).set("blockui", n)
			};
	...
	KTDrawer = function (e, t)
	{
		...
		if (null != e)
		{
			var i = {
				...
				{
					n.options = KTUtil.deepExtend(
					{}, i, t), n.uid = KTUtil.getUniqueId("drawer"), n.element = e, n.overlayElement = null, n.name = n.element.getAttribute("data-kt-drawer-name"), n.shown = !1, n.lastWidth, n.lastHeight, n.toggleElement = null, n.element.setAttribute("data-kt-drawer", "true"), o(), u(), KTUtil.data(n.element).set("drawer", n)
				},
				o = function ()
				{
					var e = m("toggle"),
...
var KTFeedback = function (e)
{
	var t = this,
		...
		i = function ()
		{
			...
			{}, n, e), t.uid = KTUtil.getUniqueId("feedback"), t.element, t.shown = !1, r(), KTUtil.data(t.element).set("feedback", t)
		},
		r = function ()
		{
	...
	KTMenu = function (e, t)
	{
		...
		if (null != e)
		{
			var i = {
				...
				{
					n.options = KTUtil.deepExtend(
					{}, i, t), n.uid = KTUtil.getUniqueId("menu"), n.element = e, n.triggerElement, n.disabled = !1, n.element.setAttribute("data-kt-menu", "true"), d(), u(), KTUtil.data(n.element).set("menu", n)
				},
				o = function (e)
				{
	...
	KTScroll = function (e, t)
	{
		...
		if (e)
		{
			var i = {
				...
				{
					n.options = KTUtil.deepExtend(
					{}, i, t), n.element = e, n.id = n.element.getAttribute("id"), n.element.setAttribute("data-kt-scroll", "true"), l(), KTUtil.data(n.element).set("scroll", n)
				},
				o = function (e)
				{
...
var KTScrolltop = function (e, t)
{
	...
	if (null != e)
	{
		var i = {
			...
			{
				n.options = KTUtil.deepExtend(
				{}, i, t), n.uid = KTUtil.getUniqueId("scrolltop"), n.element = e, n.element.setAttribute("data-kt-scrolltop", "true"), o(), KTUtil.data(n.element).set("scrolltop", n)
			},
			o = function ()
			{
	...
	KTSticky = function (e, t)
	{
		...
		if (null != e)
		{
			var i = {
				...
				r = function ()
				{
					n.element = e, n.options = KTUtil.deepExtend(
	...
	KTSwapper = function (e, t)
	{
		...
		if (null != e)
		{
			var i = {
				...
				{
					n.element = e, n.options = KTUtil.deepExtend(
					{}, i, t), n.element.setAttribute("data-kt-swapper", "true"), o(), KTUtil.data(n.element).set("swapper", n)
				},
				o = function (t)
				{
					var n = a("parent"),
