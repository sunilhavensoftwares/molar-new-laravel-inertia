                                ...
                                <div className="fv-row mb-9">
                                    ...
                                    <label className="form-check form-check-custom form-check-solid">
                                        ...
                                        <span className="form-check-label fw-semibold"
                                            htmlFor="kt_calendar_datepicker_allday">All Day</span>
                                    </label>
                ...
                <div className="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-header border-0 justify-content-end">
                            ...
                            <div className="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"
                            ...
                            <div className="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                            ...
                            <div className="btn btn-icon btn-sm btn-color-gray-500 btn-active-icon-primary"
