...
export default function Index({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Alarm Messages</h2>}
        >
            <Head title="Alarm Messages" />
            <>
                {/*begin::Main*/}
                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/*end::Item*/}
                                        {/*begin::Item*/}
                                        <li className="breadcrumb-item text-muted"> Alarm Messages</li>
                                        {/*end::Item*/}
                                    </ul>
                                    {/*end::Breadcrumb*/}
                                </div>
                                        ...
                                        <div className="card-title">
                                            ...
                                            <div className="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" data-kt-user-table-filter="search"
                                                    ...
                                                    placeholder="Search Alarm Messages" />
                                            </div>
                                            {/*end::Search*/}
                                        </div>
                                        {/*begin::Card title*/}
                                            ...
                                            <div className="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <div className="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                    ...
                                                    <div className="px-7 py-5" data-kt-user-table-filter="form">
                                                        ...
                                                        <div className="mb-10">
                                                            <label className="form-label fs-6 fw-semibold">Alarm Messages For:</label>
                                                            <Select2Input className="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="Alarm Messagess" data-hide-search="true">
                                                                <option></option>
                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr className="text-start text-muted fw-bold fs-7 text-uppercase bg-light gs-0">
                                                        ...
                                                        <th className="min-w-115px">Message</th>
                                                ...
                                                <tbody className="text-gray-600 fw-semibold">
                                                    ...
                                                    <tr>
                                                        ...
                                                        {/*begin::User=*/}
                                                        <td>
                                                            <span className="badge badge-light">admin@dms.com</span>
                                                        </td>
                                                        {/*end::User=*/}
                                                        <td>
                                                            Lipsum is simply dummy text of the printing and typesetting industry.
                                                        </td>
                                                        <td>
                                                            view
                                                        </td>
