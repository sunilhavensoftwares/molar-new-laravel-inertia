                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/*end::Item*/}
                                        {/*begin::Item*/}
                                        <li className="breadcrumb-item text-muted"> Notification</li>
                                        {/*end::Item*/}
                                    </ul>
                                    {/*end::Breadcrumb*/}
                                </div>
                                                ...
                                                <div className="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                    ...
                                                    <div className="px-7 py-5" data-kt-user-table-filter="form">
                                                        ...
                                                        <div className="mb-10">
                                                            ...
                                                            <Select2Input className="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="doctors" data-hide-search="true">
                                                                <option></option>
                                                        ...
                                                        <div className="mb-10">
                                                            <label className="form-label fs-6 fw-semibold">Notification For:</label>
                                                            <Select2Input className="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="notifications" data-hide-search="true">
                                                                <option></option>
                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr className="text-start text-muted fw-bold fs-7 text-uppercase bg-light gs-0">
                                                        ...
                                                        <th className="min-w-115px">Type</th>
                                                ...
                                                <tbody className="text-gray-600 fw-semibold">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>محمد ابراهيم صديق ال رحمن Patient case history not updated</td>
                                                        {/*begin::User=*/}
                                                        <td>
                                                            {/*begin::User details*/}
                                                            <Link href="/doctors/doctor-detail/57"
                                                                className="text-gray-800 text-hover-primary mb-1">احمد صلاح</Link>
                                                        ...
                                                        {/*begin::Role=*/}
                                                        <td>
                                                            <span className="badge badge-light">02 Jun, 2025 08:30:05</span>
                                                        </td>
                                                        {/*end::Role=*/}
                                                        <td><button className="btn btn-primary btn-active-light-primary btn-sm">Details</button></td>
                                                        {/*begin::Action=*/}
                                                        <td className="pe-4">
                                                            ...
                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 "
                                                                ...
                                                                <div className="menu-item px-3">
                                                                    <a href="#"
                                                                        className="menu-link px-3">Mark as read</a>
                                                                </div>
                                                                {/*end::Menu item*/}
                                                                {/*begin::Menu item*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#"
                                                                        className="menu-link px-3">Patient details</a>
                                                                </div>
                                                                {/*end::Menu item*/}
                                                                {/*begin::Menu item*/}
                                                                <div className="menu-item px-3">
