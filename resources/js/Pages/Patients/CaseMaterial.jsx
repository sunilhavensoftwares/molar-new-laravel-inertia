                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <tbody className="text-gray-600 fw-semibold">
                                                    <tr>
                                                        ...
                                                        {/*begin::Customer=*/}
                                                        <td>
                                                            <span className="text-gray-800 text-hover-primary mb-1">Glubs</span>
                                                        </td>
                                                        {/*end::Customer=*/}
                                                        {/*begin::Status=*/}
                                                        <td>
                                                            28 
                                                            <a href="#" className="btn btn-info btn-sm" data-bs-toggle="modal"
                                                        ...
                                                        <td className="">
                                                            ...
                                                            <a href="#" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-target="#kt_modal_add_material" data-bs-toggle="modal">
                                                    ...
                                                    <tr>
                                                        ...
                                                        {/*begin::Customer=*/}
                                                        <td>
                                                            <span className="text-gray-800 text-hover-primary mb-1">Syringe</span>
                                                        </td>
                                                        {/*end::Customer=*/}
                                                        {/*begin::Status=*/}
                                                        <td>
