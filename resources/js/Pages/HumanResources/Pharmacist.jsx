...
export default function Pharmacist({ auth }) {
    const { pharmacists, query } = usePage().props;
    ...
    useEffect(() => {
        ...
        searchTimeout.current = setTimeout(() => {
            router.get(route('human_resources.role', { human_resource: 'pharmacist' }), {
                ...appliedFilters,
                page: 1,
                perPage: pharmacists.per_page,
                sort: query?.sort,
                order: query?.order,
    ...
    const editHumanResource = async (resourse_name, id) => {
        await api.post(route('human_resources.edit', { human_resource: resourse_name }), { human_resource: resourse_name, id: id }).then((response) => {
            if (response.status === 200) {
                ...
                const modalEl = document.getElementById('kt_modal_add_edit_human_resource_pharmacist');
    ...
    const columns = [
        { label: 'ID', key: 'id', thProps: { className: 'min-w-50px ps-4' }, tdProps: { className: 'ps-4' }, 'sort_key': 'pharmacists.id', 'sortable': 1 },
        { label: 'Name', key: 'name', thProps: { className: 'min-w-150px ps-4' }, tdProps: { className: 'd-flex align-items-center' }, 'sort_key': 'pharmacists.name', 'sortable': 1 },
        { label: 'Email', key: 'email', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'pharmacists.email', 'sortable': 1 },
        { label: 'Address', key: 'address', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' } },
        { label: 'Phone', key: 'phone', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'pharmacists.phone', 'sortable': 1 },
        { label: 'Actions', key: 'actions', thProps: { className: 'text-end pe-4 min-w-100px' }, tdProps: { className: 'text-end pe-4' } },
    ];
    const data = pharmacists.data.map((pharmacist, index) => (
        {
            id: pharmacist.id || '',
                ...
                <>
                    ...
                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <div className="menu-item px-3">
                            <a className="menu-link px-3" onClick={() => editHumanResource('pharmacist', pharmacist.id)}>Edit</a>
                        </div>
                        {/* end::Menu item */}
                        {/* begin::Menu item */}
                        <div className="menu-item px-3">
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Pharmacist</h2>}
        >
            <Head title="Pharmacist" />
            <>
                {/* begin::Main */}
                <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_human_resource_pharmacist" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/* end::Toolbar */}
                                                    </div>
                                                    {/* end::Card header */}
                                                            ...
                                                            <div className="card-title">
                                                                ...
                                                                <div className="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    <input type="text" data-kt-user-table-filter="search"
                                                                        ...
                                                                        placeholder="Search Pharmacist" onChange={(e) => setSearchQuery(e.target.value)} />
                                                                </div>
                                                                {/* end::Search */}
                                                            </div>
                                                            {/* begin::Card title */}
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/* begin::Modal title */}
                                                                                <h2 className="fw-bold">Export Pharmacist</h2>
                                                                                {/* end::Modal title */}
                                                                                {/* begin::Close */}
                                                                            ...
                                                                            <div className="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                                <DataExport data={pharmacists.data} resource="pharmacist" headings={['name','phone','email','address']} />
                                                                            </div>
                                                                            {/* end::Modal body */}
                                                                        </div>
                                                                        {/* end::Modal content */}
                                                            ...
                                                            <div id="kt_table_users_wrapper" className="dt-container dt-bootstrap5 dt-empty-footer">
                                                                <div id="" className="table-responsive">
                                                                    ...
                                                                    <DataTable
                                                                        ...
                                                                        currentPage={pharmacists.current_page}
                                                                        perPage={pharmacists.per_page}
                    ...
                    <AddEditHumanResource resource_name="pharmacist" editHumanResourceData={editHumanResourceData} onClose={() => setEditHumanResourceData({})} />
                </div>
                {/* end:::Main */}
            </>
        </AuthenticatedLayout>
