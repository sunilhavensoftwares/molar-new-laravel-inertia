...
export default function Accountant({ auth }) {
    ...
    const editHumanResource = async (resourse_name, id) => {
        await api.post(route('human_resources.edit', { human_resource: resourse_name }), { human_resource: resourse_name, id: id }).then((response) => {
            if (response.status === 200) {
                ...
                const modalEl = document.getElementById('kt_modal_add_edit_human_resource_accountant');
    ...
    const columns = [
        ...
        { label: 'Email', key: 'email', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'accountants.email', 'sortable': 1 },
        { label: 'Address', key: 'address', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' } },
        { label: 'Phone', key: 'phone', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'accountants.phone', 'sortable': 1 },
        { label: 'Actions', key: 'actions', thProps: { className: 'text-end pe-4 min-w-100px' }, tdProps: { className: 'text-end pe-4' } },
    ];
    const data = accountants.data.map((accountant, index) => (
        {
            id: accountant.id || '',
        ...
        >
            ...
            <>
                ...
                <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_human_resource_accountant" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/* end::Toolbar */}
                                                    </div>
                                                    {/* end::Card header */}
                                                            ...
                                                            <div className="card-title">
                                                                ...
                                                                <div className="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    <input type="text" data-kt-user-table-filter="search"
                                                                        ...
                                                                        placeholder="Search Accountant" onChange={(e) => setSearchQuery(e.target.value)} />
                                                                </div>
                                                                {/* end::Search */}
                                                            </div>
                                                            {/* begin::Card title */}
                                                            ...
                                                            <div id="kt_table_users_wrapper" className="dt-container dt-bootstrap5 dt-empty-footer">
                                                                <div id="" className="table-responsive">
                                                                    ...
                                                                    <DataTable
                                                                        ...
                                                                        currentPage={accountants.current_page}
                                                                        perPage={accountants.per_page}
                    ...
                    <AddEditHumanResource resource_name="accountant" editHumanResourceData={editHumanResourceData} onClose={() => setEditHumanResourceData({})} />
                </div>
                {/* end:::Main */}
            </>
        </AuthenticatedLayout>
