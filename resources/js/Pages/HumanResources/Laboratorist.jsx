                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src={images.avatar_300_6} alt="laboratorist 1"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src={images.avatar_300_6} alt="laboratorist 2"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src={images.avatar_300_6} alt="laboratorist 3"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src={images.avatar_300_6} alt="laboratorist 4"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
