...
export default function Laboratorist({ auth }) {
    const { laboratorists, query } = usePage().props;
    ...
    useEffect(() => {
        ...
        searchTimeout.current = setTimeout(() => {
            router.get(route('human_resources.role', { human_resource: 'laboratorist' }), {
                ...appliedFilters,
                page: 1,
                perPage: laboratorists.per_page,
                sort: query?.sort,
                order: query?.order,
    ...
    const editHumanResource = async (resourse_name, id) => {
        await api.post(route('human_resources.edit', { human_resource: resourse_name }), { human_resource: resourse_name, id: id }).then((response) => {
            if (response.status === 200) {
                ...
                const modalEl = document.getElementById('kt_modal_add_edit_human_resource_laboratorist');
    ...
    const columns = [
        { label: 'ID', key: 'id', thProps: { className: 'min-w-50px ps-4' }, tdProps: { className: 'ps-4' }, 'sort_key': 'laboratorists.id', 'sortable': 1 },
        { label: 'Name', key: 'name', thProps: { className: 'min-w-150px ps-4' }, tdProps: { className: 'd-flex align-items-center' }, 'sort_key': 'laboratorists.name', 'sortable': 1 },
        { label: 'Email', key: 'email', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'laboratorists.email', 'sortable': 1 },
        { label: 'Address', key: 'address', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' } },
        { label: 'Phone', key: 'phone', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' }, 'sort_key': 'laboratorists.phone', 'sortable': 1 },
        { label: 'Actions', key: 'actions', thProps: { className: 'text-end pe-4 min-w-100px' }, tdProps: { className: 'text-end pe-4' } },
    ];
    const data = laboratorists.data.map((laboratorist, index) => (
        {
            id: laboratorist.id || '',
            name: laboratorist.name || '',
            email: laboratorist.email || '',
            address: laboratorist.address || '',
            phone: laboratorist.phone || '',
            actions: (
                <>
                    ...
                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <div className="menu-item px-3">
                            <a className="menu-link px-3" onClick={() => editHumanResource('laboratorist', laboratorist.id)}>Edit</a>
                        </div>
                        {/* end::Menu item */}
                        {/* begin::Menu item */}
                        <div className="menu-item px-3">
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Laboratorist</h2>}
        >
            <Head title="Laboratorist" />
            <>
                {/* begin::Main */}
                <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                                        Human Resources - Laboratorist</h1>
                                    {/* end::Title */}
                                    {/* begin::Breadcrumb */}
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_human_resource_laboratorist" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/* end::Toolbar */}
                                                    </div>
                                                    {/* end::Card header */}
                                                            ...
                                                            <div className="card-title">
                                                                ...
                                                                <div className="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    <input type="text" data-kt-user-table-filter="search"
                                                                        ...
                                                                        placeholder="Search Laboratorist" onChange={(e) => setSearchQuery(e.target.value)} />
                                                                </div>
                                                                {/* end::Search */}
                                                            </div>
                                                            {/* begin::Card title */}
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/* begin::Modal title */}
                                                                                <h2 className="fw-bold">Export Laboratorist</h2>
                                                                                {/* end::Modal title */}
                                                                                {/* begin::Close */}
                                                                            ...
                                                                            <div className="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                                 <DataExport data={laboratorists.data} resource="laboratorist" headings={['name','phone','email','address']} />
                                                                            </div>
                                                                            {/* end::Modal body */}
                                                                        </div>
                                                                        {/* end::Modal content */}
                                                            ...
                                                            <div id="kt_table_users_wrapper" className="dt-container dt-bootstrap5 dt-empty-footer">
                                                                <div id="" className="table-responsive">
                                                                    ...
                                                                    <DataTable
                                                                        ...
                                                                        currentPage={laboratorists.current_page}
                                                                        perPage={laboratorists.per_page}
                    ...
                    <AddEditHumanResource />
                    {/* begin::Modal - Edit Doctor */}
                    ...
                    <AddEditHumanResource resource_name="laboratorist" editHumanResourceData={editHumanResourceData} onClose={() => setEditHumanResourceData({})} />
                </div>
                {/* end:::Main */}
            </>
        </AuthenticatedLayout>
