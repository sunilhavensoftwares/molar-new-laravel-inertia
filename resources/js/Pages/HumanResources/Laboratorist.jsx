                                                            ...
                                                            <div className="card-title">
                                                                ...
                                                                <div className="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    <input type="text" data-kt-user-table-filter="search"
                                                                        ...
                                                                        placeholder="Search Laboratorist" />
                                                                </div>
                                                                {/* end::Search */}
                                                            </div>
                                                            {/* begin::Card title */}
                                                        ...
                                                        <div className="card-body py-4">
                                                            <div id="kt_table_users_wrapper" className="dt-container dt-bootstrap5 dt-empty-footer">
                                                                <div id="" className="table-responsive">
                                                                    {/* begin::Table */}
                                                                    <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_laboratorist">
                                                                        {/* begin::Table head */}
                                                                        <thead>
                                                                            {/* begin::Table row */}
                                                                            <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                                                ...
                                                                                <th>ID</th>
                                                                                <th className="min-w-125px">Laboratorist</th>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src="/assets/media/avatars/300-6.jpg" alt="laboratorist 1"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="d-flex flex-column">
                                                                                        <a href="doctors/doctor-detail.php"
                                                                                            className="text-gray-800 text-hover-primary mb-1">laboratorist 1</a>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src="/assets/media/avatars/300-6.jpg" alt="laboratorist 2"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="d-flex flex-column">
                                                                                        <a href="doctors/doctor-detail.php"
                                                                                            className="text-gray-800 text-hover-primary mb-1">laboratorist 2</a>
                                                                                        <span>smith@kpmg.com</span>
                                                                                    </div>
                                                                                    {/* begin::User details */}
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src="/assets/media/avatars/300-6.jpg" alt="laboratorist 3"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="d-flex flex-column">
                                                                                        <a href="doctors/doctor-detail.php"
                                                                                            className="text-gray-800 text-hover-primary mb-1">laboratorist 3</a>
                                                                                        <span>smith@kpmg.com</span>
                                                                                    </div>
                                                                                    {/* begin::User details */}
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                        <a href="doctors/doctor-detail.php">
                                                                                            <div className="symbol-label">
                                                                                                <img src="/assets/media/avatars/300-6.jpg" alt="laboratorist 4"
                                                                                                    className="w-100" />
                                                                                            </div>
                                                                                        </a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="d-flex flex-column">
                                                                                        <a href="doctors/doctor-detail.php"
                                                                                            className="text-gray-800 text-hover-primary mb-1">laboratorist 4</a>
                                                                                        <span>smith@kpmg.com</span>
                                                                                    </div>
                                                                                    {/* begin::User details */}
                                                                                </td>
                        ...
                        <div className="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-header" id="kt_modal_add_edit_human_resource_header">
                                    {/* begin::Modal title */}
                                    <h2 className="fw-bold">Add |Edit Laboratorist</h2>
                                    {/* end::Modal title */}
                                    {/* begin::Close */}
                                    <div className="btn btn-icon btn-sm btn-active-icon-primary"
                                        data-bs-dismiss="modal">
