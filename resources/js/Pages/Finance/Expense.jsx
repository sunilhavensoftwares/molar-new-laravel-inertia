                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/* end::Item*/}
                                        {/* begin::Item*/}
                                        <li className="breadcrumb-item text-muted">Expense</li>
                                        {/* end::Item*/}
                                    </ul>
                                    {/* end::Breadcrumb*/}
                                </div>
                                        ...
                                        <div className="card-toolbar">
                                            ...
                                            <div className="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" className="btn btn-light-primary me-3" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_export_expense">
                                            ...
                                            <div className="modal fade" id="kt_modal_export_expense" tabIndex="-1" aria-hidden="true">
                                                {/* begin::Modal dialog*/}
                                                <div className="modal-dialog modal-dialog-centered">
                                                    ...
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body scroll-y">
                                                            {/* begin::Form*/}
                                                            <form id="kt_modal_export_expense_form" className="form" action="#">
                                            ...
                                            <div className="modal fade" id="kt_modal_add_expense" tabIndex="-1" aria-hidden="true">
                                                {/* begin::Modal dialog*/}
                                                                ...
                                                                <div className="d-flex flex-column scroll-y me-n7 pe-7">
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        ...
                                                                        <select className="form-select form-select-sm form-select-solid"
                                                                            data-control="select2" name="category" data-placeholder="Options"
                                                                            data-hide-search="true">
                                                                            <option defaultValue="1" >Category1</option>
                                                                            <option defaultValue="2" >Category2</option>
                                                                            <option defaultValue="2" >Category3</option>
                                                                        </select>
                                                                        {/* end::Input*/}
                                                                    </div>
                                                                    {/* end::Input group*/}
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="text-center">
                                                        <div className="d-flex flex-wrap justify-content-center gap-3">
                                                            <a href="finance/expense-invoice.php" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
