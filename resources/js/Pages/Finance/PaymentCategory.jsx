                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/* end::Item */}
                                        {/* begin::Item */}
                                        <li className="breadcrumb-item text-muted">Payment Categories</li>
                                        {/* end::Item */}
                                    </ul>
                                    {/* end::Breadcrumb */}
                                </div>
                            ...
                            <div id="kt_app_content_container" className="app-container container-fluid">
                                ...
                                <div className="card">
                                        ...
                                        <div className="card-toolbar">
                                            ...
                                            <div className="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" className="btn btn-light-primary me-3" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_export_payment_category">
                                            ...
                                            <div className="modal fade" id="kt_modal_export_payment_category" tabIndex="-1" aria-hidden="true">
                                                {/* begin::Modal dialog */}
                                                <div className="modal-dialog modal-dialog-centered">
                                                    ...
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body scroll-y">
                                                            {/* begin::Form */}
                                                            <form id="kt_modal_export_payment_category_form" className="form" action="#">
                                                                {/* begin::Input group */}
                                                        ...
                                                        <div className="modal-body scroll-y">
                                                            ...
                                                            <form id="kt_modal_add_user_form" className="form" >
                                                                ...
                                                                <div className="d-flex flex-column scroll-y me-n7 pe-7">
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        {/* begin::Label */}
                                                                        <label className="required fw-semibold fs-6 mb-2">Doctor Commission (%) </label>
                                                                        {/* end::Label */}
                                                                        {/* begin::Input */}
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        {/* begin::Label */}
                                                                        <label className="required fw-semibold fs-6 mb-2">Type</label>
                                                                        {/* end::Label */}
                                                                        {/* begin::Input */}
                                                                        <select className="form-select form-select-sm form-select-solid"
                                                                            data-control="select2" name="color_name" data-placeholder="Options"
                                                                            data-hide-search="true">
                                                                            <option defaultValue="1" >Diagnostic</option>
                                                                            <option defaultValue="2" className="text-primary">Others</option>
                                                                        </select>
                                                                        {/* end::Input */}
                                                                    </div>
                                                                    {/* end::Input group */}
                                    ...
                                    <div className="card-body py-4">
                                        {/* begin::Table */}
                                        <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_payment_category">
                                            {/* begin::Table head */}
                                            <thead>
                                                {/* begin::Table row */}
