...
export default function Index({ auth }) {
    return (
        <AuthenticatedLayout user={auth} header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Expense Category</h2>}>
                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/* end::Item*/}
                                        {/* begin::Item*/}
                                        <li className="breadcrumb-item text-muted">Expense Categories</li>
                                        {/* end::Item*/}
                                    </ul>
                                    {/* end::Breadcrumb*/}
                                </div>
                                ...
                                <div className="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" className="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_expense_category">
                                        ...
                                        <div className="card-toolbar">
                                            ...
                                            <div className="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" className="btn btn-light-primary me-3" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_export_expense_category">
                                            ...
                                            <div className="modal fade" id="kt_modal_export_expense_category" tabIndex="-1" aria-hidden="true">
                                                {/* begin::Modal dialog*/}
                                                <div className="modal-dialog modal-dialog-centered ">
                                                    ...
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body scroll-y">
                                                            {/* begin::Form*/}
                                                            <form id="kt_modal_export_expense_category_form" className="form" action="#">
                                                                {/* begin::Input group*/}
                                            ...
                                            <div className="modal fade" id="kt_modal_add_expense_category" tabIndex="-1" aria-hidden="true">
                                                {/* begin::Modal dialog*/}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div className="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                            <input className="form-check-input " type="checkbox" value="" defaultChecked id="kt_flexSwitchCustomDefault_1_1" />
                                                        </div>
                                                    </td>
                                                    {/* end::Customer=*/}
