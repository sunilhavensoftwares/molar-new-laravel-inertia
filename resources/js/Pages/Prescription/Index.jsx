                                    ...
                                    <div className="card-header border-0 pt-6">
                                        ...
                                        <div className="card-toolbar">
                                            ...
                                            <div className="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                <div className="me-3">
                                                    {/*begin::Select2*/}
                                                    <Select2Input className="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Type" data-kt-ecommerce-product-filter="status">
                                                        <option></option>
                                            ...
                                            <div className="select_clone_div d-none">
                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr className="text-start text-muted fw-bold fs-7 text-uppercase bg-light gs-0">
                                                        ...
                                                        <th className="min-w-125px">Medicine</th>
                                                ...
                                                <tbody className="text-gray-600 fw-semibold">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span className="badge badge-light">3 March 2023 </span>
                                                        </td>
                                                        {/*begin::User=*/}
                                                        <td className="">
                                                            {/*begin::User details*/}
                                                            ...
                                                            <Link href="/patients/patient-detail/12"
                                                                className="text-gray-800 text-hover-primary mb-1">Emma Smith</Link>
                                                        ...
                                                        {/*begin::Role=*/}
                                                        <td>
                                                            <Link href="/doctors/doctor-detail/44" className="text-gray-800 text-hover-primary">Dr Faisal</Link>
                                                        </td>
                                                        {/*end::Role=*/}
                                                        <td>Amoxicillin -50 | 4</td>
                                                        {/*begin::Action=*/}
                                                        <td className="pe-4">
                                                            ...
                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 "
                                                                ...
                                                                <div className="menu-item px-3">
                                                                    <Link href="/prescription/1"
                                                                        className="menu-link px-3">view</Link>
                                                                </div>
                                                                {/*end::Menu item*/}
                                                                {/*begin::Menu item*/}
                                                                <div className="menu-item px-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="">
                                                            {/*begin::User details*/}
                                                            <a href="/patients/patient-detail/12"
