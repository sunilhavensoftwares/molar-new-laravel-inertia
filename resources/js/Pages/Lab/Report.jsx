...
export default function Report({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Lab Report</h2>}
        >
            <Head title="Lab Report" />
            <>
                {/*begin::Main*/}
                                    ...
                                    <div className="card-body pb-0">
                                        ...
                                        <ul className="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15">
                                            ...
                                            <li className="nav-item mt-2">
                                                <Link className="nav-link text-active-primary ms-0 me-10  show active" href="/lab/report">Reports</Link>
                                            </li>
                                            {/*end::Nav item*/}
                                            {/*begin::Nav item*/}
                                            <li className="nav-item mt-2">
                                                <Link className="nav-link text-active-primary ms-0 me-10  " href="/lab/report-templates">Templates</Link>
                                            </li>
                                            {/*end::Nav item*/}
                                        </ul>
                                        {/*begin::Navs*/}
                                                ...
                                                <div className="card mb-5 mb-xl-10">
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_lab_report" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/*end::Toolbar*/}
                                                    </div>
                                                    {/*end::Card header*/}
                                                    ...
                                                    <div className="card border-0">
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Export Reports</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                                ...
                                                                                <form id="kt_modal_add_edit_lab_report_form" className="form" >
                                                                                    ...
                                                                                    <div className="d-flex flex-column scroll-y me-n7 pe-7">
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            <div className="row g-3">
                                                                                                <div className="col-md-6">
                                                                                                    ...
                                                                                                    {/*end::Label*/}
                                                                                                    {/*begin::Input*/}
                                                                                                    <Select2Input name="format" data-control="select2" data-placeholder="Select Doctor"
                                                                                                        className="form-select form-select-solid fw-bold"
                                                                                                        data-dropdown-parent="#kt_modal_add_edit_lab_report">
                                                                                                        <option></option>
                                                                                                ...
                                                                                                <div className="col-md-6">
                                                                                                    ...
                                                                                                    {/*end::Label*/}
                                                                                                    {/*begin::Input*/}
                                                                                                    <Select2Input name="format" data-control="select2" data-placeholder="Select Template"
                                                                                                        className="form-select form-select-solid fw-bold"
                                                                                                        data-dropdown-parent="#kt_modal_add_edit_lab_report">
                                                                                                        <option></option>
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            <CKEditor name="kt_rep_desc_ckeditor_classic" id="kt_rep_desc_ckeditor_classic" className="form-control form-control-solid" rows="5"></CKEditor>
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Actions*/}
                                                        ...
                                                        <div className="card-body py-4">
                                                            {/*begin::Table*/}
                                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_reports">
                                                                {/*begin::Table head*/}
                                                                <thead>
                                                                    {/*begin::Table row*/}
                                                                ...
                                                                <tbody className="text-gray-600 fw-semibold">
                                                                    ...
                                                                    <tr className="py-2">
                                                                        ...
                                                                        <td>2025-07-03 11:11:56</td>
                                                                        {/*begin::Action=*/}
                                                                        <td>
                                                                            <div className="d-flex justify-content-end">
                                                                                <a className="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
