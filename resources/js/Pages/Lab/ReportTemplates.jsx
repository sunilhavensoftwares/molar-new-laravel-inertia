...
export default function ReportTemplates({ auth }) {

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Prescription</h2>}
        >
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_report_template" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/*end::Toolbar*/}
                                                    </div>
                                                    {/*end::Card header*/}
                                                    ...
                                                    <div className="card border-0">
                                                        ...
                                                        <div className="card-header border-0 pt-6">
                                                            ...
                                                            <div className="card-toolbar">
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Export Report templates</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                ...
                                                                {/*end::Modal - New Card*/}
                                                                <div className="modal fade" id="kt_modal_add_edit_report_template" aria-hidden="true">
                                                                    {/*begin::Modal dialog*/}
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        {/*begin::Modal content*/}
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Add | Edit Lab Report Template</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                            ...
                                                                            <div className="modal-body scroll-y">
                                                                                {/*begin::Form*/}
                                                                                <form id="kt_modal_add_edit_report_template_form" className="form" >
                                                                                    {/*begin::Scroll*/}
                                                                                    <div className="d-flex flex-column scroll-y me-n7 pe-7">
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Message*/}
                                                                                            <input type="text" name="kt_rep_temp_ckeditor_classic" className="form-control form-control-solid" />
                                                                                            {/*end::Message*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Input group*/}
                                                                                        <div className="fv-row mb-7">
                                                                                            {/*begin::Label*/}
                                                                                            <label className="required fw-semibold fs-6 mb-2">Template Description </label>
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Message*/}
                                                                                            <CKEditor name="kt_rep_temp_ckeditor_classic" id="kt_rep_temp_ckeditor_classic" className="form-control form-control-solid" rows="5"></CKEditor>
                                                                                            {/*end::Message*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Actions*/}
                                                        ...
                                                        <div className="card-body py-4">
                                                            {/*begin::Table*/}
                                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_report-templates">
                                                                {/*begin::Table head*/}
                                                                <thead>
                                                                    {/*begin::Table row*/}
                                                                        ...
                                                                        <td className="text-end">
                                                                            ...
                                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                                ...
                                                                                <div className="menu-item px-3">
                                                                                    <a href="#" className="menu-link px-3" data-bs-target="#kt_modal_add_edit_report_template" data-bs-toggle="modal">Edit</a>
                                                                                </div>
                                                                                {/*end::Menu item*/}
                                                                                {/*begin::Menu item*/}
                                                                                <div className="menu-item px-3">
