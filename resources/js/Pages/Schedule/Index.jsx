                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/* end::Item*/}
                                        {/* begin::Item*/}
                                        <li className="breadcrumb-item text-muted">Schedules</li>
                                        {/* end::Item*/}
                                    </ul>
                                    {/* end::Breadcrumb*/}
                                </div>
                                                                ...
                                                                <div className="d-flex flex-column">
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        <div className="row g-3">
                                                                            <div className="col-md-6">
                                                                                ...
                                                                                <label
                                                                                    className="required fw-semibold fs-6 mb-2">Doctor</label>
                                                                                {/*  <button type="button" className="btn btn-primary btn-sm float-end mb-2">Add</button> */}
                                                                                <span className="badge badge-primary badge-lg float-end"
                                                                                ...
                                                                                <Select2Input className="form-select form-select-solid"
                                                                                    ...
                                                                                    data-dropdown-parent="#modal_add_schedule" data-placeholder="Select Doctor">
                                                                                    <option></option>
                                                                            ...
                                                                            <div className="col-md-6">
                                                                                {/* begin::Label*/}
                                                                                <label
                                                                                    className="required fw-semibold fs-6 mb-2">Weekday</label>
                                                                                {/* end::Label*/}
                                                                                {/* begin::Input*/}
                                                                                <Select2Input className="form-select form-select-solid"
                                                                                    data-control="select2" aria-label="Select example"
                                                                                    data-dropdown-parent="#modal_add_schedule"
                                                                                    data-placeholder="Select Weekday"
                                                                                >
                                                                                    <option></option>
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        <div className="row g-3">
                                                                            <div className="col-md-6">
                                                                                {/* begin::Label*/}
                                                                                <label className="required fw-semibold fs-6 mb-2">Start
                                                                                    Time</label>
                                                                                {/* end::Label*/}
                                                                                {/* begin::Input*/}
                                                                            ...
                                                                            <div className="col-md-6">
                                                                                {/* begin::Label*/}
                                                                                <label className="required fw-semibold fs-6 mb-2">End
                                                                                    Time</label>
                                                                                {/* end::Label*/}
                                                                                {/* begin::Input*/}
                                                                    ...
                                                                    <div className="fv-row mb-7">
                                                                        ...
                                                                        {/* end::Label*/}
                                                                        {/* begin::Input*/}
                                                                        <Select2Input className="form-select form-select-solid" data-placeholder="Select Duration">
                                                                            <option></option>
