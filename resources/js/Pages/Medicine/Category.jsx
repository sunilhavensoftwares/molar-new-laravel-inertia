...
export default function Category({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Medicine Category</h2>}
        >
            ...
            <>
                ...
                <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/*end::Item*/}
                                        {/*begin::Item*/}
                                        <li className="breadcrumb-item text-muted">Medicine Category</li>
                                        {/*end::Item*/}
                                    </ul>
                                    {/*end::Breadcrumb*/}
                                </div>
                                ...
                                <div className="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" className="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modal_add_medicine_category">
                    ...
                    <div className="modal fade" id="modal_add_medicine_category" tabIndex="-1" aria-hidden="true">
                        {/*begin::Modal dialog*/}
                        <div className="modal-dialog modal-dialog-centered mw-650px">
                            {/*begin::Modal content*/}
                            <div className="modal-content">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        <select className="form-select form-select-solid" data-control="select2"
                                                            aria-label="Select example" data-dropdown-parent="#modal_add_schedule">
