...
export default function Index({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Users Activities</h2>}
        >
            <Head title="Users Activities" />
            <>
                {/*begin::Main*/}
                            ...
                            <div id="kt_app_toolbar_container" className="app-container container-fluid d-flex flex-stack">
                                ...
                                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        {/*end::Item*/}
                                        {/*begin::Item*/}
                                        <li className="breadcrumb-item text-muted"> Users Activities</li>
                                        {/*end::Item*/}
                                    </ul>
                                    {/*end::Breadcrumb*/}
                                </div>
                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr className="text-start text-muted fw-bold fs-7 text-uppercase bg-light gs-0">
                                                        ...
                                                        <th className="min-w-125px">Activity User Name</th>
                                                        <th className="min-w-125px">Activity User Email</th>
                                                        <th className="min-w-115px">Message</th>
                                                        <th className="min-w-125px">Activity Type</th>
                                                        <th className="min-w-125px">Details</th>
                                                        <th className="min-w-125px">Action Status</th>
                                                ...
                                                <tbody className="text-gray-600 fw-semibold">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {/*begin::User details*/}
                                                            <Link href="/patients/patient-detail/12"
                                                                className="text-gray-800 text-hover-primary mb-1">Admin</Link>

                                                            {/*begin::User details*/}
                                                        </td>
                                                        {/*end::User=*/}
                                                        <td>
                                                            <span className="badge badge-light">emmasmith@test.com</span>
                                                        </td>
                                                        {/*begin::Role=*/}
                                                        <td>
                                                            Admin Added a appointment
                                                        </td>
                                                        {/*end::Role=*/}
                                                        <td>Delete</td>
                                                        <td><button className="btn btn-info btn-active-light-primary btn-sm">view</button></td>
                                                        ...
                                                        <td className="pe-4">
                                                            ...
                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 "
                                                                ...
                                                                <div className="menu-item px-3">
                                                                    <a href="#"
                                                                        className="menu-link px-3">Accept</a>
                                                                </div>
                                                                {/*end::Menu item*/}
                                                                     {/*begin::Menu item*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#"
                                                                        className="menu-link px-3">Reject</a>
                                                                </div>
                                                                {/*end::Menu item*/}
                                                                     {/*begin::Menu item*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#"
                                                                        className="menu-link px-3">Remove Log</a>
                                                                </div>
                                                                {/*end::Menu item*/}
