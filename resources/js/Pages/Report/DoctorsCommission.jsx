...
export default function Index({ auth }) {
    ...
    return (
        ...
        >
            <Head title="Report - Doctor Commission" />
            <>
                {/*begin::Main*/}
                                                ...
                                                <div className="card mb-5 mb-xl-10">
                                                    ...
                                                    <div className="card border-0">
                                                        ...
                                                        <div className="card-header border-0 pt-6">
                                                            ...
                                                            <div className="card-title">
                                                                ...
                                                                <div className="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    <input type="text" data-kt-user-table-filter="search"
                                                                        ...
                                                                        placeholder="Search Doctors Commission" />
                                                                </div>
                                                                {/*end::Search*/}
                                                            </div>
                                                            {/*begin::Card title*/}
                                                                ...
                                                                <div className="d-flex flex-wrap justify-content-end gap-3" data-kt-user-table-toolbar="base">
                                                                    ...
                                                                    <div className="w-100 w-md-150px">
                                                                        ...
                                                                        <button type="button" className="btn btn-light-primary me-3 w-150px" data-bs-toggle="modal"
                                                                            data-bs-target="#kt_modal_export_doctors-commission">
                                                            ...
                                                            <div className="modal fade" id="kt_modal_export_doctors-commission" tabIndex="-1" aria-hidden="true">
                                                                {/*begin::Modal dialog*/}
                                                                <div className="modal-dialog modal-dialog-centered mw-500px">
                                                                    ...
                                                                    <div className="modal-content">
                                                                        ...
                                                                        <div className="modal-body scroll-y">
                                                                            {/*begin::Form*/}
                                                                            <form id="kt_modal_export_doctors-commission_form" className="form" action="#">
                                                        ...
                                                        <div className="card-body py-4">
                                                            {/*begin::Table*/}
                                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_doctors-commission">
                                                                {/*begin::Table head*/}
                                                                <thead>
                                                                    {/*begin::Table row*/}
                                                                ...
                                                                <tbody className="text-gray-600 fw-semibold">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                            <a href="report/index.php?tab=doctors-commission-details" >Doctor 1</a>
                                                                        </td>
                                                                        {/*end::Last login=*/}
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                        ...
                                                                        <td className="text-end">
                                                                            ...
                                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                                ...
                                                                                <div className="menu-item px-3">
                                                                                    <a href="report/index.php?tab=doctors-commission-details" className="menu-link px-3" data-bs-target="#kt_modal_add_edit_report_template" data-bs-toggle="modal">Details</a>
                                                                                </div>
                                                                                {/*end::Menu item*/}
                                                                            </div>
                                                                            {/*end::Menu*/}
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                            <a href="report/index.php?tab=doctors-commission-details" >Doctor 2</a>
                                                                        </td>
                                                                        {/*end::Last login=*/}
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                            <a href="report/index.php?tab=doctors-commission-details" >Doctor 3</a>
                                                                        </td>
                                                                        {/*end::Last login=*/}
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {/*begin::Last login=*/}
                                                                        <td>
                                                                            <a href="report/index.php?tab=doctors-commission-details" >Doctor 4</a>
                                                                        </td>
                                                                        {/*end::Last login=*/}
                                                                        {/*begin::Last login=*/}
                                                                        <td>
