...
const Slides = ({ auth }) => {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Website - Services</h2>}
        >
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_service" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/*end::Toolbar*/}
                                                    </div>
                                                    {/*end::Card header*/}
                                                    ...
                                                    <div className="card border-0">
                                                        ...
                                                        <div className="card-header border-0 pt-6">
                                                            ...
                                                            <div className="card-toolbar">
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Export Services</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                ...
                                                                {/*end::Modal - New Card*/}
                                                                <div className="modal fade" id="kt_modal_add_edit_service" tabIndex="-1" aria-hidden="true">
                                                                    {/*begin::Modal dialog*/}
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        {/*begin::Modal content*/}
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header" id="kt_modal_add_user_header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Add/Edit Service</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                                <div className="btn btn-icon btn-sm btn-active-icon-primary"
                                                                                    data-bs-dismiss="modal">
                                                                                ...
                                                                                <form id="kt_modal_add_user_form" className="form" >
                                                                                    ...
                                                                                    <div className="d-flex flex-column scroll-y me-n7 pe-7"
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            {/*begin::Label*/}
                                                                                            <label className="d-block fw-semibold fs-6 mb-5">Service Image</label>
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Image input*/}
                                                                                            <div className="image-input image-input-outline image-input-placeholder"
                                                                                                ...
                                                                                                <div className="image-input-wrapper w-125px h-125px"
                                                                                                    style={{backgroundImage: `url(${images.implant})`}}>
                                                                                                </div>
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    {/*begin::Inputs*/}
                                                                                                    <input type="file" name="svc_image"
                                                                                                        accept=".png, .jpg, .jpeg" />
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Input*/}
                                                                                            <input type="text" name="svc_title"
                                                                                                className="form-control form-control-solid mb-3 mb-lg-0"
                                                                                                placeholder="Service Title" defaultValue="" />
                                                                                            {/*end::Input*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Input group*/}
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Message*/}
                                                                                            <QuillInput id="kt_svc_description" className="bg-transparent h-150px px-3 ql-container ql-snow" />
                                                                                            {/*end::Message*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                    </div>
                                                        ...
                                                        <div className="card-body py-4">
                                                            {/*begin::Table*/}
                                                            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_services">
                                                                {/*begin::Table head*/}
                                                                <thead>
                                                                    {/*begin::Table row*/}
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                <a href="#">
                                                                                    <div className="symbol-label">
                                                                                        <img src={images.implant} alt="Service 1"
                                                                                            className="w-100" />
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                                            ...
                                                                            <div className="d-flex flex-column">
                                                                                <a href="#"
                                                                                    className="text-gray-800 text-hover-primary mb-1">Service 1</a>
                                                                            </div>
                                                                            {/*begin::User details*/}
                                                                        </td>
                                                                        {/*end::User=*/}
                                                                        ...
                                                                        <td className="text-end">
                                                                            ...
                                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                                ...
                                                                                <div className="menu-item px-3">
                                                                                    <a href="#" className="menu-link px-3" data-bs-target="#kt_modal_add_edit_service" data-bs-toggle="modal">Edit</a>
                                                                                </div>
                                                                                {/*end::Menu item*/}
                                                                                {/*begin::Menu item*/}
                                                                                <div className="menu-item px-3">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                <a href="#">
                                                                                    <div className="symbol-label">
                                                                                        <img src={images.implant} alt="Service 2"
                                                                                            className="w-100" />
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                                            ...
                                                                            <div className="d-flex flex-column">
                                                                                <a href="#"
                                                                                    className="text-gray-800 text-hover-primary mb-1">Service 2</a>
                                                                            </div>
                                                                            {/*begin::User details*/}
                                                                        </td>
                                                                        {/*end::User=*/}
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                <a href="#">
                                                                                    <div className="symbol-label">
                                                                                        <img src={images.implant} alt="Service 3"
                                                                                            className="w-100" />
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                                            ...
                                                                            <div className="d-flex flex-column">
                                                                                <a href="#"
                                                                                    className="text-gray-800 text-hover-primary mb-1">Service 3</a>
                                                                            </div>
                                                                            {/*begin::User details*/}
                                                                        </td>
                                                                        {/*end::User=*/}
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                                <a href="#">
                                                                                    <div className="symbol-label">
                                                                                        <img src={images.implant} alt="Service 4"
                                                                                            className="w-100" />
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                                            ...
                                                                            <div className="d-flex flex-column">
                                                                                <a href="#"
                                                                                    className="text-gray-800 text-hover-primary mb-1">Service 4</a>
                                                                            </div>
                                                                            {/*begin::User details*/}
                                                                        </td>
                                                                        {/*end::User=*/}
