...
export default function Index({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Pharmacy Expense Categories</h2>}
        >
            <Head title="Pharmacy Expense Categories" />
            <>
                {/*begin::Main*/}
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_edit_expense_category" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/*end::Toolbar*/}
                                                    </div>
                                                    {/*end::Card header*/}
                                                    ...
                                                    <div className="card border-0">
                                                        ...
                                                        <div className="card-header border-0 pt-6">
                                                            ...
                                                            <div className="card-toolbar">
                                                                    ...
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        ...
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Export Expense Categories</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                ...
                                                                {/*end::Modal - New Card*/}
                                                                <div className="modal fade" id="kt_modal_add_edit_expense_category" tabIndex="-1" aria-hidden="true">
                                                                    {/*begin::Modal dialog*/}
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        {/*begin::Modal content*/}
                                                                        <div className="modal-content">
                                                                            {/*begin::Modal header*/}
                                                                            <div className="modal-header" id="kt_modal_add_edit_expense_category_header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Add/Edit Expense Category</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                                <div className="btn btn-icon btn-sm btn-active-icon-primary"
                                                                                    data-bs-dismiss="modal">
                                                                            ...
                                                                            <div className="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                                {/*begin::Form*/}
                                                                                <form id="kt_modal_add_edit_expense_category_form" className="form" >
                                                                                    {/*begin::Scroll*/}
                                                                                    <div className="d-flex flex-column scroll-y me-n7 pe-7"
                                                                                        id="kt_modal_add_edit_expense_category_scroll" data-kt-scroll="true"
                                                                                        data-kt-scroll-activate="{default: false, lg: true}"
                                                                                        data-kt-scroll-max-height="auto"
                                                                                        data-kt-scroll-dependencies="#kt_modal_add_edit_expense_category_header"
                                                                                        data-kt-scroll-wrappers="#kt_modal_add_edit_expense_category_scroll"
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Input*/}
                                                                                            <input type="text" name="phrm_exp_category_name"
                                                                                                className="form-control form-control-solid mb-3 mb-lg-0"
                                                                                                placeholder="Category name" defaultValue="" />
                                                                                            {/*end::Input*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Input group*/}
                                                                                        <div className="fv-row mb-7">
                                                                                            {/*begin::Label*/}
                                                                                            <label
                                                                                                className="required fw-semibold fs-6 mb-2">Category Description</label>
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Input*/}
                                                                                            <input type="text" name="phrm_category_description"
                                                                                                className="form-control form-control-solid mb-3 mb-lg-0"
                                                                        ...
                                                                        <td className="text-end">
                                                                            ...
                                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                                ...
                                                                                <div className="menu-item px-3">
                                                                                    <a href="#" className="menu-link px-3" data-bs-target="#kt_modal_add_edit_expense_category" data-bs-toggle="modal">Edit</a>
                                                                                </div>
                                                                                {/*end::Menu item*/}
                                                                                {/*begin::Menu item*/}
                                                                                <div className="menu-item px-3">
