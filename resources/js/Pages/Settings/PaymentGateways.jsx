                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="tab-content" id="myTabContent">
                                            {/*begin:::Tab pane*/}
                                            <div className="tab-pane fade active show" id="kt_ecommerce_settings_pgateways" role="tabpanel">
                                                    ...
                                                    <div className="card-header">
                                                        ...
                                                        <div className="card-toolbar">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_pgateway" className="btn btn-sm btn-primary my-1">Add</a>
                                                        </div>
                                                        {/*end::Toolbar*/}
                                                    </div>
                                                    {/*end::Card header*/}
                                                    ...
                                                    <div className="card border-0">
                                                        ...
                                                        <div className="card-header border-0 pt-6">
                                                            ...
                                                            <div className="card-toolbar">
                                                                ...
                                                                {/*end::Modal - New Card*/}
                                                                <div className="modal fade" id="kt_modal_add_pgateway" tabIndex="-1" aria-hidden="true">
                                                                    {/*begin::Modal dialog*/}
                                                                    <div className="modal-dialog modal-dialog-centered mw-650px">
                                                                        {/*begin::Modal content*/}
                                                                        <div className="modal-content">
                                                                            ...
                                                                            <div className="modal-header" id="kt_modal_add_user_header">
                                                                                {/*begin::Modal title*/}
                                                                                <h2 className="fw-bold">Add/Edit Payment Gateway</h2>
                                                                                {/*end::Modal title*/}
                                                                                {/*begin::Close*/}
                                                                                <div className="btn btn-icon btn-sm btn-active-icon-primary"
                                                                                    data-bs-dismiss="modal">
                                                                                    ...
                                                                                    <div className="d-flex flex-column scroll-y me-n7 pe-7"
                                                                                        ...
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            <input type="text" name="pg_name"
                                                                                                ...
                                                                                                placeholder="Payment Gateway Name" defaultValue="" />
                                                                                            {/*end::Input*/}
                                                                                        </div>
                                                                                        {/*end::Input group*/}
                                                                                        {/*begin::Input group*/}
                                                                                        <div className="fv-row mb-7">
                                                                                            ...
                                                                                            {/*end::Label*/}
                                                                                            {/*begin::Input*/}
                                                                                            <input type="password" name="pg_description"
                                                                                                className="form-control form-control-solid mb-3 mb-lg-0"
                                                        ...
                                                        <div className="card-body py-4">
                                                            <div className="table-responsive">
                                                                {/*begin::Table*/}
                                                                <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_doctors">
                                                                    {/*begin::Table head*/}
                                                                    <thead>
                                                                        {/*begin::Table row*/}
                                                                        <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                                            ...
                                                                            <th className="min-w-200px">Status( Sandbox {'<==>'} Live )</th>
                                                                    ...
                                                                    <tbody className="text-gray-600 fw-semibold">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex flex-column">
                                                                                    <a href="#"
                                                                                        className="text-gray-800 text-hover-primary mb-1">Payment Gateway 1</a>
                                                                                </div>
                                                                                {/*begin::details*/}
                                                                            </td>
                                                                            <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt aliquid, labore repellat magni aut expedita saepe dicta vel.</td>
                                                                            <td>
                                                                                <div className="d-flex justify-content-center form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                            ...
                                                                            <td className="text-end">
                                                                                ...
                                                                                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                                    ...
                                                                                    <div className="menu-item px-3">
                                                                                        <a href="#" className="menu-link px-3" data-bs-target="#kt_modal_add_pgateway" data-bs-toggle="modal">Edit</a>
                                                                                    </div>
                                                                                    {/*end::Menu item*/}
                                                                                    {/*begin::Menu item*/}
                                                                                    <div className="menu-item px-3">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex flex-column">
                                                                                    <a href="#"
                                                                                        className="text-gray-800 text-hover-primary mb-1">Payment Gateway 2</a>
                                                                                </div>
                                                                                {/*begin::details*/}
                                                                            </td>
                                                                            <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt aliquid, labore repellat magni aut expedita saepe dicta vel.</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex flex-column">
                                                                                    <a href="#"
                                                                                        className="text-gray-800 text-hover-primary mb-1">Payment Gateway 3</a>
                                                                                </div>
                                                                                {/*begin::details*/}
                                                                            </td>
                                                                            <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt aliquid, labore repellat magni aut expedita saepe dicta vel.</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex flex-column">
                                                                                    <a href="#"
                                                                                        className="text-gray-800 text-hover-primary mb-1">Payment Gateway 4</a>
                                                                                </div>
                                                                                {/*begin::details*/}
                                                                            </td>
                                                                            <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt aliquid, labore repellat magni aut expedita saepe dicta vel.</td>
