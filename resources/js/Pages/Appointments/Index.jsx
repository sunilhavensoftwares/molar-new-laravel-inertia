...
const columns = [
    ...
    { label: 'Doctor Time', key: 'doctor_time', thProps: { className: 'min-w-80px ps-4' }, tdProps: { className: '' } },
            ...
            <>
                ...
                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                    ...
                    <div className="menu-item px-3">
                        <Link href={`/patients/patient-detail/${appointment.patient.id}/case-history`} className="menu-link px-3">History</Link>
                    </div>
                    {/*end::Menu item*/}
                    {/*begin::Menu item*/}
                    <div className="menu-item px-3">
                        <a data-bs-toggle="modal" data-bs-target="#modal_add_appointment" className="menu-link px-3">Edit</a>
                    </div>
                    {/*end::Menu item*/}
                    {/*begin::Menu item*/}
                    <div className="menu-item px-3">
                                    ...
                                    <div className="card-toolbar ">
                                        ...
                                        <div className="d-flex flex-wrap justify-content-end gap-3" data-kt-user-table-toolbar="base">
                                            <div className="w-100 w-md-150px">
                                                {/* begin::Select2*/}
                                                <Select2Input className="form-select form-select-solid" name="status" data-control="select2"
                                                    data-hide-search="true" data-placeholder="Type" onChange={handleStatusFilterChange('status')}>
                                                    {Object.entries(appointment_status_list).map(([label, value]) => (
                                                    ...
                                                    <div className="px-7 py-5" data-kt-user-table-filter="form">
                                                        ...
                                                        <div className="mb-10">
                                                            ...
                                                            <Select2Input className="form-select form-select-solid fw-bold"
                                                                ...
                                                                data-hide-search="true" name="doctor"
                                                                value={filters.selectedFilterDoctorId || ''} 
                                                                onChange={(value) => handleFilterChange('selectedFilterDoctorId')(value)}
                                                                ajax={{
                                                                    url: '/doctors/search',
                                                                    delay: 250,
                                                                    data: (params) => ({
                                                        ...
                                                        <div className="mb-10">
                                                            ...
                                                            <FlatpickrInput type="text" placeholder='Select Date'
                                                                className="form-control form-control-solid kt_datepicker_1" name="date" 
                                                                 value={filters.selectedFilteredDate || ''} 
                                                                 onChange={(value) => handleFilterChange('selectedFilteredDate')(value)}
                                                                />
                                                        </div>
                                                        {/* end::Input group*/}
                                                        {/* begin::Actions*/}
